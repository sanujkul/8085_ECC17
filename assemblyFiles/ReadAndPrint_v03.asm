...
MAIN_LOOP: ; Read sid data and print onLCD
	MVI A, 31H;
	CALL DTAOUT; Print 1 before reading byte
GPSREAD:	CALL SIDATA; Data stored in B register
	MVI A, 32H;   Print 2 after reading byte
	CALL DTAOUT;
PRINTGPS:	MOV A,B;
	CALL DTAOUT
...
;FUNCTION- BIT TIME
;Calling this subroutine will cause delay of 100us (incluing call)
BITTIME:    PUSH B;
	PUSH PSW;
	MVI B, 10H;
bitTimeloop: DCR B;
...
;Calling this subroutine will cause delay of 48us (incluing call)
HAFBIT:    PUSH B;
	PUSH PSW;
	MVI B, 05H;
hafTimeloop: DCR B;
